...
async function getRanking() {
    const response = await fetch('https://sandbix.fr/grsapi/get-ranking-html', {
        method: 'POST',
        body: JSON.stringify({
            size: ""
        }),
...
async function getTournaments() {
    const response = await fetch('https://sandbix.fr/grsapi/get-tournaments-html', {
        method: 'POST',
        body: JSON.stringify({
            size: ""
        }),
...
async function getResults(tournament_id=-1) {
    const response = await fetch('https://sandbix.fr/grsapi/get-results-html', {
        method: 'POST',
        body: JSON.stringify({
    ...
    const tournaments = await response.text()
    const response_ = await fetch('https://sandbix.fr/grsapi/get-tournament-name-html', {
        method: 'POST',
        body: JSON.stringify({
            tournament_id: tournament_id
        }),
